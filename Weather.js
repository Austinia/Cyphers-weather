...
const weatherOptions = {
  Haze: {
    ...
    title: "안개가 좀 꼈네요..",
    subtitle: "탱커에게 안개 속에 적들이 숨었나 시야 봐달라고 하세요"
  },
  Clear: {
    iconName: "weather-sunny",
    gradient: ["#0072ff", "#00c6ff"],
    title: "화창하네요!",
    subtitle: "탐라에다가 외쳐요 샆할샆~~! 1/5"
  },
  Fog: {
    iconName: "weather-fog",
    gradient: ["#EAEAEA", "#DBDBDB", "#F2F2F2", "#ADA996"],
    title: "안개가 좀 짙네요..",
    subtitle: "탱커에게 안개 속에 적들이 숨었나\n시야 봐달라고 하세요"
  },
  Mist: {
    iconName: "weather-fog",
    gradient: ["#EAEAEA", "#DBDBDB", "#F2F2F2", "#ADA996"],
  ...
  Sand: {
    ...
    title: "모래바람이 부네요",
    subtitle: "???: 나를 우습게 본 대가를 치뤄야지"
  },
  Dust: {
    iconName: "weather-fog",
    gradient: ["#333333", "#e9d362"],
    title: "미세먼지가 많네요",
    subtitle: "여러분 아무래도 출근 하지 말고 사퍼를 해야겠어요"
  },
  Smoke: {
    iconName: "weather-fog",
  ...
  Drizzle: {
    ...
    title: "가랑비가 내려요",
    subtitle: "서버 상태에 주의하시면서 플레이 하세요"
  },
  Squall: {
    iconName: "weather-windy",
    gradient: ["#1FA2FF", "#12D8FA", "#A6FFCB"],
    title: "강풍이 불어요",
    subtitle: "이런, 서버 상태가 그닥 좋지 않을거에요"
  }
}
